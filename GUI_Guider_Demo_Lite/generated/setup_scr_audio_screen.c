...
void setup_scr_audio_screen(lv_ui *ui){
	...
	//Write codes audio_screen_label_2
	ui->audio_screen_label_2 = lv_label_create(ui->audio_screen, NULL);
	lv_label_set_text(ui->audio_screen_label_2, "Microphone Input");
	lv_label_set_long_mode(ui->audio_screen_label_2, LV_LABEL_LONG_BREAK);
	lv_label_set_align(ui->audio_screen_label_2, LV_LABEL_ALIGN_LEFT);

	//Write style LV_LABEL_PART_MAIN for audio_screen_label_2
	static lv_style_t style_audio_screen_label_2_main;
	lv_style_reset(&style_audio_screen_label_2_main);

	//Write style state: LV_STATE_DEFAULT for style_audio_screen_label_2_main
	lv_style_set_radius(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 0);
	lv_style_set_bg_color(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_dir(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, LV_GRAD_DIR_VER);
	lv_style_set_bg_opa(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 255);
	lv_style_set_text_color(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, &lv_font_Montserrat_medium_30);
	lv_style_set_text_letter_space(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 2);
	lv_style_set_pad_left(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_right(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_top(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_bottom(&style_audio_screen_label_2_main, LV_STATE_DEFAULT, 0);
	lv_obj_add_style(ui->audio_screen_label_2, LV_LABEL_PART_MAIN, &style_audio_screen_label_2_main);
	lv_obj_set_pos(ui->audio_screen_label_2, 61, 254);
	lv_obj_set_size(ui->audio_screen_label_2, 386, 0);
